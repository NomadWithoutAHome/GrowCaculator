...
function v2.Return_All_Data() --[[Anonymous function at line 2936]]
    --[[
    Upvalues:
        [1] = u4
    --]]
...
function v2.Return_All_Seeds() --[[Anonymous function at line 2939]]
    --[[
    Upvalues:
        [1] = u10
    --]]
...
function v2.Return_All_Seed_Rarities() --[[Anonymous function at line 2942]]
    --[[
    Upvalues:
        [1] = u9
    --]]
...
function v2.Return_Seed_Data(p11) --[[Anonymous function at line 2945]]
    --[[
    Upvalues:
        [1] = u10
    --]]
    for _, v12 in pairs(u10) do
        if v12[1] == p11 then
            return v12
        end
    end
...
function v2.Return_Rarity_Data(p13) --[[Anonymous function at line 2954]]
    --[[
    Upvalues:
        [1] = u9
    --]]
...
function v2.Return_Variant_Multiplier(p15) --[[Anonymous function at line 2961]]
    --[[
    Upvalues:
        [1] = u3
    --]]
    for _, v16 in pairs(u3) do
        if v16[1] == p15 then
            return v16[3]
        end
    end
...
function v2.Return_Random_Variant(p17) --[[Anonymous function at line 2972]]
    --[[
    Upvalues:
        [1] = u3
    --]]
...
function v2.Return_Random_Super_Variant() --[[Anonymous function at line 2995]]
    --[[
    Upvalues:
        [1] = u8
    --]]
    local v24 = 0
    for _, v25 in ipairs(u8) do
        v24 = v24 + v25[2]
    end
    local v26 = math.random(1, v24)
    local v27 = 0
    for _, v28 in ipairs(u8) do
        v27 = v27 + v28[2]
        if v26 <= v27 then
            return v28[1]
        end
...
function v2.Return_Data(p29) --[[Anonymous function at line 3013]]
    --[[
    Upvalues:
        [1] = u1
        [2] = u4
    --]]
    local v30 = u1:StipFlavourText(p29)
    for _, v31 in u4 do
        if v31[1] == v30 then
            return v31
        end
